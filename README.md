...
## Mapping
First I removed adapters and trimmed reads using TrimGalore, discarding reads with a Phred score below 20 and removing Ns. Then reads were mapped using bwa mem with default settings. Using samtools, duplicates were marked and, after some statistics, discarded. I also filtered out reads with a MQ below 20. QC results can be found in the respective subspecies folders red, black and blue in mapping/outputs/.
## Variant calling
